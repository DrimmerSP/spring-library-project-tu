...
VALUES (nextval('authors_sequence'), 'admin', '2022-11-15 13:46:11.797607', 'Александр Грибоедов', 'Писатель Александр Грибоедов ' ||
...
INSERT INTO authors (id, created_by, created_when, fio, description, birth_date)
VALUES (nextval('authors_sequence'), 'admin', '2022-11-15 13:47:02.414728', 'Джейн Остин',
        ...
        '1775-12-16');
INSERT INTO authors (id, created_by, created_when, fio, description, birth_date)
VALUES (nextval('authors_sequence'), 'admin', '2022-11-15 13:48:53.363059', 'Федор Достоевский',
        ...
        '1821-11-11');
INSERT INTO authors (id, created_by, created_when, fio, description, birth_date)
VALUES (nextval('authors_sequence'), 'admin', '2022-11-15 13:50:12.953413', 'Эмили Бронте',
        ...
        '1818-07-30');
INSERT INTO authors (id, created_by, created_when, fio, description, birth_date)
VALUES (nextval('authors_sequence'), 'admin', '2022-11-15 13:51:08.314682', 'Михаил Булгаков',
        ...
        '1891-05-15');
INSERT INTO authors (id, created_by, created_when, fio, description, birth_date)
VALUES (nextval('authors_sequence'), 'admin', '2022-11-15 13:51:08.314682', 'Илья Ильф', 'настоящее имя — Иехиел-Лейб бен Арьевич Файнзильберг; 1897—1937', '1897-01-01');
INSERT INTO authors (id, created_by, created_when, fio, description, birth_date)
VALUES (nextval('authors_sequence'), 'admin', '2022-11-15 13:51:08.314682', 'Евгений Петров', 'настоящее имя — Евгений Петрович Катаев; 1902—1942', '1902-01-01');
...
VALUES (nextval('books_sequence'), 'admin', '2022-11-15 13:54:28.115079', 100, 3, null, '1966-01-01', '1-М', 'Мастер и Маргарита', 'журнал «Москва»', 416);
INSERT INTO books (id, created_by, created_when, amount, genre, online_copy_path, publish_date, storage_place, title, publish, page_count)
VALUES (nextval('books_sequence'), 'admin', '2022-11-15 13:56:12.600618', 10, 3, null, '1925-01-01', '1-Б', 'Белая Гвардия', 'журнал «Россия»', 416);
INSERT INTO books (id, created_by, created_when, amount, genre, online_copy_path, publish_date, storage_place, title, publish, page_count)
VALUES (nextval('books_sequence'), 'admin', '2022-11-15 13:57:05.231780', 11, 2, null, '2023-01-15', '17-Г', 'Грозовой перевал', 'Азбука, 2023 г.', 384);
INSERT INTO books (id, created_by, created_when, amount, genre, online_copy_path, publish_date, storage_place, title, publish, page_count)
VALUES (nextval('books_sequence'), 'admin', '2022-11-15 13:57:43.883671', 11, 3, null, '2022-01-01', '1-И', 'Идиот', 'Эксмо', 636);
INSERT INTO books (id, created_by, created_when, amount, genre, online_copy_path, publish_date, storage_place, title, publish, page_count)
VALUES (nextval('books_sequence'), 'admin', '2022-11-15 13:58:12.172216', 111, 2, null, '2022-03-22', '13-Г', 'Гордость и предубеждение', 'АСТ', 416);
INSERT INTO books (id, created_by, created_when, amount, genre, online_copy_path, publish_date, storage_place, title, publish, page_count)
VALUES (nextval('books_sequence'), 'admin', '2022-11-15 13:58:12.172216', 110, 2, null, '2016-03-11', '1-Г', 'Горе от ума', 'Азбука', 256);
INSERT INTO books (id, created_by, created_when, amount, genre, online_copy_path, publish_date, storage_place, title, publish, page_count)
VALUES (nextval('books_sequence'), 'admin', '2022-11-15 13:58:12.172216', 2, 3, null, '2016-03-11', '1-Г', 'Золотой теленок', 'Текст', 432);
